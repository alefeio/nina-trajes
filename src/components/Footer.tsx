                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-32">
                        ...
                        <div className="flex flex-col items-center md:items-start text-center md:text-left">
                            ...
                            <div className="space-y-2">
                                <p>
                                    <a href="tel:+5591983169340" className="hover:text-pink-500 transition-colors text-black/70">
                                        +55 (91) 98316-9340
                                    </a>
                                </p>
                            ...
                            <div className="flex space-x-4">
                                ...
                                <a href="https://www.instagram.com/ninatrajes" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-2xl hover:text-pink-500 transition-colors">
